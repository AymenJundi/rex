  ...
  return (
    ...
    >
          ...
          {navLinks.map(({ id, title }) => (
            <li key={id} className="relative">
              <Link
                ...
                className={`text-white text-[13px] sm:text-[15px] font-semibold cursor-pointer transition-all duration-300 relative ${
      ...
      <div className="sm:hidden flex justify-end items-center relative z-30">
        ...
        <div
          className={`fixed top-0 left-0 h-full w-[70%] bg-[#1746ff] transform ${toggle ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out z-20 shadow-lg p-6`}
          style={{ borderRadius: "0px" }}
        >
